...
from chapter5.util.read_ini import readIni
...
class FindElement:
    ...
    def findElement(self,key):
        ...
        try:
            ...
            print("findElement函数定位【",eleInfo,"】元素失败------------>")
            imagePath = "chapter5/image/%s.png" %eleInfo
            filePath = os.path.join(basePath,imagePath)
