...
from chapter5.util.excel_util import excelUtil
caseList = excelUtil.getData()
@ddt.ddt
class RegisterDdtCase(unittest.TestCase):
    ...
    @ddt.data(*caseList)
    def testRegisterCase(self,caseData):
        email,username,password,codeImagePath,assertKey,assertValue = caseData
        #调用business层方法
